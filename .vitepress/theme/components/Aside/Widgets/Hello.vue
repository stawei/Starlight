...
<template>
  <div class="hello s-card" @mouseleave="resetHello">
    ...
    <div class="content">
      <div class="site-logo">
        <img :src="theme.siteMeta.author.cover" alt="avatar" class="avatar" />
      </div>
    ...
    <div class="info">
      ...
      <div class="link">
        <a href="https://github.com/stawei/" target="_blank" class="social-link">
          <i class="iconfont icon-github"></i>
        </a>
        <a href="mailto:2963286491@qq.com" target="_blank" class="social-link">
